...
const clientUrl = SUPABASE_URL || 'https://pghwzfrskvaivpspgewp.supabase.co'
const clientKey = SUPABASE_PUBLISHABLE_KEY || 'sb_publishable_PzvGw_p9XTFOAh4IzMh9Pg_yspCXIjr'
